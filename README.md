...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/oZjw6RNYG2)
...
```sh
npx nx serve minecraft-locations
```

To create a production bundle:

```sh
npx nx build minecraft-locations
```

To see all available targets to run for a project, run:

```sh
npx nx show project minecraft-locations
```
